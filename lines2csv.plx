...
# Needs Perl 5 (other versions may work) as well as grep and sed (because I've been too laz to fix the script)
...
# cat sabre_last28days_cw_tables_20201128.txt | sed -e "s/,//g"|grep -v ^$|./lines2csv.plx 
